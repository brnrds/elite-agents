---
title: "The CTWOS variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/variable/ctwos.html"
---

[TWOS2](twos2.md "Previous routine")[LOINQ (Part 1 of 7)](../subroutine/loinq_part_1_of_7.md "Next routine")
       ...
       Category: Drawing pixels
        ...
        Context: See this variable [in context in the source code](../../all/elite_a.md#header-ctwos)
     References: This variable is used as follows:
                 * [CPIXK](../subroutine/cpixk.md) uses CTWOS
                 * [DIL2](../subroutine/dil2.md) uses CTWOS
