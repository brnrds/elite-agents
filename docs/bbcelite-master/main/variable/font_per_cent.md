---
title: "The FONT% variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/variable/font_per_cent.html"
---

[ADDK](../subroutine/addk.md "Previous routine")[log](log.md "Next routine")
       ...
       Category: Text
        ...
        Context: See this variable [in context in the source code](../../all/elite_a.md#header-font-per-cent)
     ...
     References: This variable is used as follows:
                 * [CHPR](../subroutine/chpr.md) uses FONT%
