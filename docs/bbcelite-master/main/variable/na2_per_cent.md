---
title: "The NA2% variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/variable/na2_per_cent.html"
---

[S1%](s1_per_cent.md "Previous routine")[shpcol](shpcol.md "Next routine")
      ...
      Deep dive: [Commander save files](https://elite.bbcelite.com/deep_dives/commander_save_files.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_a.md#header-na2-per-cent)
     ...
     References: This variable is used as follows:
                 * [JAMESON](../subroutine/jameson.md) uses NA2%
...
Configuration variable [Q%](../../all/workspaces.md#q-per-cent) = _MAX_COMMANDER
