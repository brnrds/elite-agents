---
title: "The MTIN variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/variable/mtin.html"
---

[ping](../subroutine/ping.md "Previous routine")[SCALEY](../subroutine/scaley.md "Next routine")
      ...
      Deep dive: [Extended text tokens](https://elite.bbcelite.com/deep_dives/extended_text_tokens.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_c.md#header-mtin)
     References: This variable is used as follows:
                 * [DETOK2](../subroutine/detok2.md) uses MTIN
