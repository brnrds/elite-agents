---
title: "The NWSHP subroutine - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/subroutine/nwshp.html"
---

[NWSPS](nwsps.md "Previous routine")[NwS1](nws1.md "Next routine")
       ...
       Category: Universe
        ...
        Context: See this subroutine [in context in the source code](../../all/elite_e.md#header-nwshp)
     ...
     References: This subroutine is called as follows:
                 * [BRIEF](brief.md) calls NWSHP
                 * [FRS1](frs1.md) calls NWSHP
                 * [GTHG](gthg.md) calls NWSHP
                 * [KS4](ks4.md) calls NWSHP
                 * [Main game loop (Part 1 of 6)](main_game_loop_part_1_of_6.md) calls NWSHP
                 * [Main game loop (Part 2 of 6)](main_game_loop_part_2_of_6.md) calls NWSHP
                 * [Main game loop (Part 3 of 6)](main_game_loop_part_3_of_6.md) calls NWSHP
                 * [Main game loop (Part 4 of 6)](main_game_loop_part_4_of_6.md) calls NWSHP
                 * [SFS1](sfs1.md) calls NWSHP
                 * [SOLAR](solar.md) calls NWSHP
                 * [SOS1](sos1.md) calls NWSHP
                 * [TITLE](title.md) calls NWSHP
...
Configuration variable [JH](../../all/workspaces.md#jh) = SHU+2

Junk is defined as ending before the Cobra Mk III

[X]

Configuration variable [JL](../../all/workspaces.md#jl) = ESC
...
Label [NW1](nwshp.md#nw1) is local to this routine

[X]

Label [NW2](nwshp.md#nw2) is local to this routine

[X]

Label [NW3](nwshp.md#nw3) is local to this routine

[X]

[X]

Label [NW4](nwshp.md#nw4) is local to this routine

[X]

Label [NW6](nwshp.md#nw6) is local to this routine

[X]

Label [NW7](nwshp.md#nw7) is local to this routine

[X]

Label [NW8](nwshp.md#nw8) is local to this routine

[X]

Label [NWL1](nwshp.md#nwl1) is local to this routine

[X]

Label [NWL3](nwshp.md#nwl3) is local to this routine
...
Label [gangbang](nwshp.md#gangbang) is local to this routine
