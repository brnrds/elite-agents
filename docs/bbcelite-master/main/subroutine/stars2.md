---
title: "The STARS2 subroutine - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/subroutine/stars2.html"
---

[HFS2](hfs2.md "Previous routine")[MU5](mu5.md "Next routine")
      ...
      Deep dive: [Stardust in the side views](https://elite.bbcelite.com/deep_dives/stardust_in_the_side_views.html)
        ...
        Context: See this subroutine [in context in the source code](../../all/elite_c.md#header-stars2)
...
Subroutine [DV41](dv41.md) (category: Maths (Arithmetic))

Calculate (P R) = 256 * DELTA / A

[X]

Label [KILL2](stars2.md#kill2) is local to this routine
...
Label [ST2](stars2.md#st2) is local to this routine

[X]

Label [ST5](stars2.md#st5) is local to this routine

[X]

Label [STC2](stars2.md#stc2) is local to this routine

[X]

Label [STF1](stars2.md#stf1) is local to this routine

[X]

Label [STL2](stars2.md#stl2) is local to this routine
...
Variable [newzp](../workspace/zp.md#newzp) in workspace [ZP](../workspace/zp.md)
