---
title: "The DVID3B2 subroutine - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/subroutine/dvid3b2.html"
---

[DVID4](dvid4.md "Previous routine")[cntr](cntr.md "Next routine")
      ...
      Deep dive: [Shift-and-subtract division](https://elite.bbcelite.com/deep_dives/shift-and-subtract_division.html)
        ...
        Context: See this subroutine [in context in the source code](../../all/elite_c.md#header-dvid3b2)
     ...
     References: This subroutine is called as follows:
                 * [PLANET](planet.md) calls DVID3B2
                 * [PLS1](pls1.md) calls DVID3B2
                 * [PLS6](pls6.md) calls DVID3B2
...
Label [DV12](dvid3b2.md#dv12) is local to this routine

[X]

Label [DV13](dvid3b2.md#dv13) is local to this routine

[X]

Label [DV14](dvid3b2.md#dv14) is local to this routine

[X]

Label [DVL10](dvid3b2.md#dvl10) is local to this routine

[X]

Label [DVL6](dvid3b2.md#dvl6) is local to this routine

[X]

Label [DVL8](dvid3b2.md#dvl8) is local to this routine

[X]

Label [DVL9](dvid3b2.md#dvl9) is local to this routine
...
Label [LL29new](dvid3b2.md#ll29new) is local to this routine

[X]

Label [LL312new](dvid3b2.md#ll312new) is local to this routine

[X]

Label [LL31new](dvid3b2.md#ll31new) is local to this routine
