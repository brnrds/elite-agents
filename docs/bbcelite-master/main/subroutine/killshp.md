---
title: "The KILLSHP subroutine - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/subroutine/killshp.html"
---

[KS2](ks2.md "Previous routine")[THERE](there.md "Next routine")
       ...
       Category: Universe
        ...
        Context: See this subroutine [in context in the source code](../../all/elite_f.md#header-killshp)
...
Subroutine [KS2](ks2.md) (category: Universe)

Check the local bubble for missiles with target lock

[X]

Subroutine [KS4](ks4.md) (category: Universe)

Remove the space station and replace it with the sun

[X]

Label [KS5](killshp.md#ks5) is local to this routine

[X]

Label [KS7](killshp.md#ks7) is local to this routine

[X]

Label [KSL1](killshp.md#ksl1) is local to this routine

[X]

Label [KSL2](killshp.md#ksl2) is local to this routine

[X]

Label [KSL3](killshp.md#ksl3) is local to this routine
...
Label [blacksuspenders](killshp.md#blacksuspenders) is local to this routine

[X]

Label [lll](killshp.md#lll) is local to this routine
