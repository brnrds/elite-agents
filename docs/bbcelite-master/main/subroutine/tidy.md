---
title: "The TIDY subroutine - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/subroutine/tidy.html"
---

[QQ23](../variable/qq23.md "Previous routine")[TIS2](tis2.md "Next routine")
      ...
      Deep dive: [Tidying orthonormal vectors](https://elite.bbcelite.com/deep_dives/tidying_orthonormal_vectors.html)
        ...
        Context: See this subroutine [in context in the source code](../../all/elite_f.md#header-tidy)
     References: This subroutine is called as follows:
                 * [HAS1](has1.md) calls TIDY
                 * [MVEIT (Part 1 of 9)](mveit_part_1_of_9.md) calls TIDY
...
Subroutine [NORM](norm.md) (category: Maths (Geometry))
...
Label [TI1](tidy.md#ti1) is local to this routine

[X]

Label [TI2](tidy.md#ti2) is local to this routine

[X]

Label [TI3](tidy.md#ti3) is local to this routine

[X]

Label [TIL1](tidy.md#til1) is local to this routine

[X]

Subroutine [TIS1](tis1.md) (category: Maths (Arithmetic))

Calculate (A ?) = (-X * A + (S R)) / 96

[X]

Subroutine [TIS3](tis3.md) (category: Maths (Arithmetic))
