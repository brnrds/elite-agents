---
title: "The MULT3 subroutine - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/subroutine/mult3.html"
---

[MU5](mu5.md "Previous routine")[MLS2](mls2.md "Next routine")
      ...
      Deep dive: [Shift-and-add multiplication](https://elite.bbcelite.com/deep_dives/shift-and-add_multiplication.html)
        ...
        Context: See this subroutine [in context in the source code](../../all/elite_c.md#header-mult3)
     References: This subroutine is called as follows:
                 * [MV40](mv40.md) calls MULT3
...
Subroutine [MU5](mu5.md) (category: Maths (Arithmetic))

Set K(3 2 1 0) = (A A A A) and clear the C flag

[X]

Label [MUL2](mult3.md#mul2) is local to this routine
