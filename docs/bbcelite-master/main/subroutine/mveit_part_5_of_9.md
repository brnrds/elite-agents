---
title: "The MVEIT (Part 5 of 9) subroutine - Elite on the 6502"
source: "https://elite.bbcelite.com/master/main/subroutine/mveit_part_5_of_9.html"
---

[MVEIT (Part 4 of 9)](mveit_part_4_of_9.md "Previous routine")[MVEIT (Part 6 of 9)](mveit_part_6_of_9.md "Next routine")
      ...
      Deep dive: [Rotating the universe](https://elite.bbcelite.com/deep_dives/rotating_the_universe.html)
        ...
        Context: See this subroutine [in context in the source code](../../all/elite_h.md#header-mveit-part-5-of-9)
...
Subroutine [MLTU2](mltu2.md) (category: Maths (Arithmetic))

Calculate (A P+1 P) = (A ~P) * Q

[X]

Entry point [MLTU2-2](mltu2.md#mltu2) in subroutine [MLTU2](mltu2.md) (category: Maths (Arithmetic))

Set Q to X, so this calculates (A P+1 P) = (A ~P) * X

[X]

Label [MV43](mveit_part_5_of_9.md#mv43) is local to this routine

[X]

Label [MV44](mveit_part_5_of_9.md#mv44) is local to this routine

[X]

Subroutine [MVT6](mvt6.md) (category: Moving)
