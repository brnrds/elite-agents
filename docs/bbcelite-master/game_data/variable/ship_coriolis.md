---
title: "The SHIP_CORIOLIS (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_coriolis.html"
---

[SHIP_MISSILE (Game data)](ship_missile.md "Previous routine")[SHIP_ESCAPE_POD (Game data)](ship_escape_pod.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_coriolis)
     ...
     References: This variable is used as follows:
                 * [XX21](xx21.md) uses SHIP_CORIOLIS
...
Label [SHIP_CORIOLIS_EDGES](ship_coriolis.md#ship_coriolis_edges) is local to this routine

[X]

Label [SHIP_CORIOLIS_FACES](ship_coriolis.md#ship_coriolis_faces) is local to this routine
