---
title: "The SHIP_DODO (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_dodo.html"
---

[SHIP_COUGAR (Game data)](ship_cougar.md "Previous routine")[CHAR (Game data)](../macro/char.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_dodo)
...
Label [SHIP_DODO_EDGES](ship_dodo.md#ship_dodo_edges) is local to this routine

[X]

Label [SHIP_DODO_FACES](ship_dodo.md#ship_dodo_faces) is local to this routine
