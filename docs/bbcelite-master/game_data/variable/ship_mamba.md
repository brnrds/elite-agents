---
title: "The SHIP_MAMBA (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_mamba.html"
---

[SHIP_SIDEWINDER (Game data)](ship_sidewinder.md "Previous routine")[SHIP_KRAIT (Game data)](ship_krait.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_mamba)
...
Label [SHIP_MAMBA_EDGES](ship_mamba.md#ship_mamba_edges) is local to this routine

[X]

Label [SHIP_MAMBA_FACES](ship_mamba.md#ship_mamba_faces) is local to this routine
