---
title: "The SHIP_COUGAR (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_cougar.html"
---

[SHIP_CONSTRICTOR (Game data)](ship_constrictor.md "Previous routine")[SHIP_DODO (Game data)](ship_dodo.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_cougar)
     References: This variable is used as follows:
                 * [XX21](xx21.md) uses SHIP_COUGAR
...
Label [SHIP_COUGAR_EDGES](ship_cougar.md#ship_cougar_edges) is local to this routine

[X]

Label [SHIP_COUGAR_FACES](ship_cougar.md#ship_cougar_faces) is local to this routine
