---
title: "The SHIP_SHUTTLE (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_shuttle.html"
---

[SHIP_SPLINTER (Game data)](ship_splinter.md "Previous routine")[SHIP_TRANSPORTER (Game data)](ship_transporter.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_shuttle)
     ...
     References: This variable is used as follows:
                 * [XX21](xx21.md) uses SHIP_SHUTTLE
...
Label [SHIP_SHUTTLE_EDGES](ship_shuttle.md#ship_shuttle_edges) is local to this routine

[X]

Label [SHIP_SHUTTLE_FACES](ship_shuttle.md#ship_shuttle_faces) is local to this routine
