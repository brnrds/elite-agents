---
title: "The SHIP_CONSTRICTOR (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_constrictor.html"
---

[SHIP_THARGON (Game data)](ship_thargon.md "Previous routine")[SHIP_COUGAR (Game data)](ship_cougar.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_constrictor)
     ...
     References: This variable is used as follows:
                 * [XX21](xx21.md) uses SHIP_CONSTRICTOR
...
Label [SHIP_CONSTRICTOR_EDGES](ship_constrictor.md#ship_constrictor_edges) is local to this routine

[X]

Label [SHIP_CONSTRICTOR_FACES](ship_constrictor.md#ship_constrictor_faces) is local to this routine
