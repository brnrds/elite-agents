---
title: "The SHIP_PYTHON (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_python.html"
---

[SHIP_COBRA_MK_3 (Game data)](ship_cobra_mk_3.md "Previous routine")[SHIP_BOA (Game data)](ship_boa.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_python)
...
Label [SHIP_PYTHON_EDGES](ship_python.md#ship_python_edges) is local to this routine

[X]

Label [SHIP_PYTHON_FACES](ship_python.md#ship_python_faces) is local to this routine
