---
title: "The SHIP_BOA (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_boa.html"
---

[SHIP_PYTHON (Game data)](ship_python.md "Previous routine")[SHIP_ANACONDA (Game data)](ship_anaconda.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_boa)
...
Label [SHIP_BOA_EDGES](ship_boa.md#ship_boa_edges) is local to this routine

[X]

Label [SHIP_BOA_FACES](ship_boa.md#ship_boa_faces) is local to this routine
