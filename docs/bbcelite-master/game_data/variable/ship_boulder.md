---
title: "The SHIP_BOULDER (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_boulder.html"
---

[SHIP_CANISTER (Game data)](ship_canister.md "Previous routine")[SHIP_ASTEROID (Game data)](ship_asteroid.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_boulder)
     ...
     References: This variable is used as follows:
                 * [XX21](xx21.md) uses SHIP_BOULDER
...
Label [SHIP_BOULDER_EDGES](ship_boulder.md#ship_boulder_edges) is local to this routine

[X]

Label [SHIP_BOULDER_FACES](ship_boulder.md#ship_boulder_faces) is local to this routine
