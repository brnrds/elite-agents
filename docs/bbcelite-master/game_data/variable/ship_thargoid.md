---
title: "The SHIP_THARGOID (Game data) variable - Elite on the 6502"
source: "https://elite.bbcelite.com/master/game_data/variable/ship_thargoid.html"
---

[SHIP_MORAY (Game data)](ship_moray.md "Previous routine")[SHIP_THARGON (Game data)](ship_thargon.md "Next routine")
      ...
      Deep dive: [Ship blueprints](https://elite.bbcelite.com/deep_dives/ship_blueprints.html)
        ...
        Context: See this variable [in context in the source code](../../all/elite_data.md#header-ship_thargoid)
     ...
     References: This variable is used as follows:
                 * [XX21](xx21.md) uses SHIP_THARGOID
...
Label [SHIP_THARGOID_EDGES](ship_thargoid.md#ship_thargoid_edges) is local to this routine

[X]

Label [SHIP_THARGOID_FACES](ship_thargoid.md#ship_thargoid_faces) is local to this routine
