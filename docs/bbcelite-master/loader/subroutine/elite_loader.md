---
title: "The Elite loader (Loader) subroutine - Elite on the 6502"
source: "https://elite.bbcelite.com/master/loader/subroutine/elite_loader.html"
---

[B% (Loader)](../variable/b_per_cent.md "Previous routine")[PLL1 (Part 1 of 3) (Loader)](pll1_part_1_of_3.md "Next routine")
       ...
       Category: Loader
        ...
        Context: See this subroutine [in context in the source code](../../all/loader.md#header-elite-loader)
...
Variable [B%](../variable/b_per_cent.md) (category: Drawing the screen)

VDU commands for setting the square mode 1 screen

[X]

Variable [LATCH](../workspace/zp.md#latch) in workspace [ZP](../workspace/zp.md)

The RAM copy of the currently selected paged ROM/RAM in SHEILA &30

[X]

Label [LOOP](elite_loader.md#loop) is local to this routine

[X]

Variable [MESS1](../variable/mess1.md) (category: Loader)

The OS command string for loading the BDATA binary

[X]

Variable [MESS2](../variable/mess2.md) (category: Loader)

The OS command string for loading the main game code binary

[X]

Variable [MESS3](../variable/mess3.md) (category: Loader)
...
Label [MPL1](elite_loader.md#mpl1) is local to this routine

[X]

Label [MPL2](elite_loader.md#mpl2) is local to this routine

[X]

Configuration variable [N%](../../all/loader.md#n-per-cent) = 67

N% is set to the number of bytes in the VDU table, so we can loop through them below

[X]

Label [OK](elite_loader.md#ok) is local to this routine

[X]

Subroutine [OSB](osb.md) (category: Utility routines)
...
Configuration variable [OSCLI](../../all/loader.md#oscli) = &FFF7

The address for the OSCLI routine

[X]

Configuration variable [OSWRCH](../../all/loader.md#oswrch) = &FFEE
...
Configuration variable [S%](../../all/loader.md#s-per-cent) = &2C6C

The address of the main entry point workspace in the main game code

[X]

Configuration variable [VIA](../../all/loader.md#via) = &FE00
