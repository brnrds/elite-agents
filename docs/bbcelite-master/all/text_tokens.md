---
title: "Text tokens in the BBC Master version of Elite - Elite on the 6502"
source: "https://elite.bbcelite.com/master/all/text_tokens.html"
---

[Ship blueprints](elite_ships.md "Previous routine")
     ...
     SKIP 619               \ These bytes appear to be unused
      ...
      Deep dive: [Printing text tokens](https://elite.bbcelite.com/deep_dives/printing_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/char.md)
     References: This macro is used as follows:
                 * [QQ18](../game_data/variable/qq18.md) uses CHAR
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Printing text tokens](https://elite.bbcelite.com/deep_dives/printing_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/twok.md)
     References: This macro is used as follows:
                 * [QQ18](../game_data/variable/qq18.md) uses TWOK
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Printing text tokens](https://elite.bbcelite.com/deep_dives/printing_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/cont.md)
     References: This macro is used as follows:
                 * [QQ18](../game_data/variable/qq18.md) uses CONT
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Printing text tokens](https://elite.bbcelite.com/deep_dives/printing_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/rtok.md)
     References: This macro is used as follows:
                 * [QQ18](../game_data/variable/qq18.md) uses RTOK
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Printing text tokens](https://elite.bbcelite.com/deep_dives/printing_text_tokens.html)
        ...
        Context: See this variable [on its own page](../game_data/variable/qq18.md)
     Variations: See [code variations](../related/compare/main/variable/qq18.md) for this variable in the different versions
     References: This variable is used as follows:
                 * [ex](../main/subroutine/ex.md) uses QQ18
    ...
    .QQ18
     ...
     EQUB &16               \ assembly process
      ...
      Deep dive: [The sine, cosine and arctan tables](https://elite.bbcelite.com/deep_dives/the_sine_cosine_and_arctan_tables.html)
        ...
        Context: See this variable [on its own page](../game_data/variable/sne.md)
     References: This variable is used as follows:
    ...
    .SNE
     ...
     NEXT
      ...
      Deep dive: [The sine, cosine and arctan tables](https://elite.bbcelite.com/deep_dives/the_sine_cosine_and_arctan_tables.html)
        ...
        Context: See this variable [on its own page](../game_data/variable/act.md)
     References: This variable is used as follows:
    ...
    * * *
    ...
    .IANTOK
      ...
      Deep dive: [Extended text tokens](https://elite.bbcelite.com/deep_dives/extended_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/ejmp.md)
     References: This macro is used as follows:
                 * [RUTOK](../game_data/variable/rutok.md) uses EJMP
                 * [TKN1](../game_data/variable/tkn1.md) uses EJMP
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Extended text tokens](https://elite.bbcelite.com/deep_dives/extended_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/echr.md)
     References: This macro is used as follows:
                 * [RUTOK](../game_data/variable/rutok.md) uses ECHR
                 * [TKN1](../game_data/variable/tkn1.md) uses ECHR
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Extended text tokens](https://elite.bbcelite.com/deep_dives/extended_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/etok.md)
     References: This macro is used as follows:
                 * [RUTOK](../game_data/variable/rutok.md) uses ETOK
                 * [TKN1](../game_data/variable/tkn1.md) uses ETOK
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Extended text tokens](https://elite.bbcelite.com/deep_dives/extended_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/etwo.md)
     References: This macro is used as follows:
                 * [RUTOK](../game_data/variable/rutok.md) uses ETWO
                 * [TKN1](../game_data/variable/tkn1.md) uses ETWO
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Extended text tokens](https://elite.bbcelite.com/deep_dives/extended_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/ernd.md)
     References: This macro is used as follows:
                 * [RUTOK](../game_data/variable/rutok.md) uses ERND
                 * [TKN1](../game_data/variable/tkn1.md) uses ERND
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Printing text tokens](https://elite.bbcelite.com/deep_dives/printing_text_tokens.html)
        ...
        Context: See this macro [on its own page](../game_data/macro/tokn.md)
     References: This macro is used as follows:
                 * [TKN1](../game_data/variable/tkn1.md) uses TOKN
    ...
    * * *
    ...
    ENDMACRO
      ...
      Deep dive: [Extended text tokens](https://elite.bbcelite.com/deep_dives/extended_text_tokens.html)
        ...
        Context: See this variable [on its own page](../game_data/variable/tkn1.md)
     Variations: See [code variations](../related/compare/main/variable/tkn1.md) for this variable in the different versions
     References: This variable is used as follows:
                 * [DETOK](../main/subroutine/detok.md) uses TKN1
    ...
    ENDIF
     ...
     EQUB VE
      ...
      Deep dive: [Extended system descriptions](https://elite.bbcelite.com/deep_dives/extended_system_descriptions.html)
        ...
        Context: See this variable [on its own page](../game_data/variable/rupla.md)
    ...
    .RUPLA
     ...
     EQUB 1                 \ System   7, Galaxy 16                  Lave = Token 26
      ...
      Deep dive: [Extended system descriptions](https://elite.bbcelite.com/deep_dives/extended_system_descriptions.html)
        ...
        Context: See this variable [on its own page](../game_data/variable/rugal.md)
    ...
    .RUGAL
     ...
     EQUB &90               \ System   7, Galaxy 16                  Lave = Token 26
      ...
      Deep dive: [Extended system descriptions](https://elite.bbcelite.com/deep_dives/extended_system_descriptions.html)
        ...
        Context: See this variable [on its own page](../game_data/variable/rutok.md)
     Variations: See [code variations](../related/compare/main/variable/rutok.md) for this variable in the different versions
     References: This variable is used as follows:
                 * [DETOK3](../main/subroutine/detok3.md) uses RUTOK
...
Configuration variable [t](elite_data.md#t) in macro [RTOK](elite_data.md#header-rtok)
