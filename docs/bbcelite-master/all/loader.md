---
title: "Loader source in the BBC Master version of Elite - Elite on the 6502"
source: "https://elite.bbcelite.com/master/all/loader.html"
---

[Map of the source code](../articles/map_of_the_source_code.md "Previous routine")[Workspaces and configuration](workspaces.md "Next routine")
    ...
    * * *
     ...
     N% = 67                \ N% is set to the number of bytes in the VDU table, so
                            ...
                            \
                            \   * [Elite loader](../loader/subroutine/elite_loader.md)
                            \
     ...
     OSCLI = &FFF7          \ The address for the OSCLI routine
       ...
       Category: Workspaces
        ...
        Context: See this workspace [on its own page](../loader/workspace/zp.md)
     ...
     References: This workspace is used as follows:
                 * [Elite loader](../loader/subroutine/elite_loader.md) uses ZP
                 * [PIX](../loader/subroutine/pix.md) uses ZP
                 * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md) uses ZP
                 * [PLL1 (Part 2 of 3)](../loader/subroutine/pll1_part_2_of_3.md) uses ZP
                 * [PLL1 (Part 3 of 3)](../loader/subroutine/pll1_part_3_of_3.md) uses ZP
                 * [ROOT](../loader/subroutine/root.md) uses ZP
    ...
    .ZP
     ...
     SKIP 2                 \ Stores addresses used for moving content around
                            ...
                            \
                            \   * [Elite loader](../loader/subroutine/elite_loader.md)
                            \   * [PIX](../loader/subroutine/pix.md)
                            \   * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md)
                            \   * [PLL1 (Part 2 of 3)](../loader/subroutine/pll1_part_2_of_3.md)
                            \   * [PLL1 (Part 3 of 3)](../loader/subroutine/pll1_part_3_of_3.md)
                            \   * [ROOT](../loader/subroutine/root.md)
                            \
                            \ This list only includes code that refers to the
                            \ variable by name; there may be other references to
                            \ this memory location that don't use this label, and
    ...
    .P
     ...
     SKIP 1                 \ Temporary storage, used in a number of places
                            ...
                            \   * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md)
                            \   * [ROOT](../loader/subroutine/root.md)
                            \   * [SQUA2](../loader/subroutine/squa2.md)
                            \
                            \ This list only includes code that refers to the
                            \ variable by name; there may be other references to
                            \ this memory location that don't use this label, and
    ...
    .LATCH
     ...
     ORG CODE%              \ Set the assembly address to CODE%
      ...
      Deep dive: [The split-screen mode in BBC Micro Elite](https://elite.bbcelite.com/deep_dives/the_split-screen_mode.html)
        ...
        Context: See this variable [on its own page](../loader/variable/b_per_cent.md)
     ...
     References: This variable is used as follows:
                 * [Elite loader](../loader/subroutine/elite_loader.md) uses B%
    ...
    .B%
     ...
     EQUB 0, 0, 0           \ This is the "cursor start" register, and bits 5 and 6
       ...
       Category: Loader
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/elite_loader.md)
    ...
    .MPL2
     ...
     JMP S%                 \ Jump to the start of the main game code at S%, which
      ...
      Deep dive: [Drawing Saturn on the loading screen](https://elite.bbcelite.com/deep_dives/drawing_saturn_on_the_loading_screen.html)
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/pll1_part_1_of_3.md)
     ...
     References: This subroutine is called as follows:
                 * [Elite loader](../loader/subroutine/elite_loader.md) calls PLL1
    ...
    .PLC1
     ...
     BNE PLL1               \ Loop back to PLL1 until CNT+1 = 0
      ...
      Deep dive: [Drawing Saturn on the loading screen](https://elite.bbcelite.com/deep_dives/drawing_saturn_on_the_loading_screen.html)
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/pll1_part_2_of_3.md)
    ...
    .PLC2
     ...
     BNE PLL2               \ Loop back to PLL2 until CNT2+1 = 0
      ...
      Deep dive: [Drawing Saturn on the loading screen](https://elite.bbcelite.com/deep_dives/drawing_saturn_on_the_loading_screen.html)
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/pll1_part_3_of_3.md)
    ...
    .PLC3
     ...
     BNE PLL3               \ Loop back to PLL3 until CNT3+1 = 0
      ...
      Deep dive: [Generating random numbers](https://elite.bbcelite.com/deep_dives/generating_random_numbers.html)
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/dornd.md)
     References: This subroutine is called as follows:
                 * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md) calls DORND
                 * [PLL1 (Part 2 of 3)](../loader/subroutine/pll1_part_2_of_3.md) calls DORND
                 * [PLL1 (Part 3 of 3)](../loader/subroutine/pll1_part_3_of_3.md) calls DORND
    ...
    .DORND
     ...
     RTS                    \ Return from the subroutine
       ...
       Category: Drawing planets
        ...
        Context: See this variable [on its own page](../loader/variable/rand.md)
     References: This variable is used as follows:
                 * [DORND](../loader/subroutine/dornd.md) uses RAND
                 * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md) uses RAND
    ...
    .RAND
     ...
     EQUD &34785349
      ...
      Deep dive: [Shift-and-add multiplication](https://elite.bbcelite.com/deep_dives/shift-and-add_multiplication.html)
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/squa2.md)
     References: This subroutine is called as follows:
                 * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md) calls SQUA2
                 * [PLL1 (Part 2 of 3)](../loader/subroutine/pll1_part_2_of_3.md) calls SQUA2
                 * [PLL1 (Part 3 of 3)](../loader/subroutine/pll1_part_3_of_3.md) calls SQUA2
    ...
    .SQ1
     ...
     RTS                    \ Return from the subroutine
       ...
       Category: Drawing pixels
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/pix.md)
     Variations: See [code variations](../related/compare/loader/subroutine/pix.md) for this subroutine in the different versions
     References: This subroutine is called as follows:
                 * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md) calls PIX
                 * [PLL1 (Part 2 of 3)](../loader/subroutine/pll1_part_2_of_3.md) calls PIX
                 * [PLL1 (Part 3 of 3)](../loader/subroutine/pll1_part_3_of_3.md) calls PIX
    ...
    .TWOS
     ...
     EQUB %00000001
       ...
       Category: Drawing planets
        ...
        Context: See this variable [on its own page](../loader/variable/cnt.md)
     Variations: See [code variations](../related/compare/loader/variable/cnt.md) for this variable in the different versions
     References: This variable is used as follows:
                 * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md) uses CNT
    ...
    .CNT
     ...
     EQUW &0300             \ The number of iterations of the PLL1 loop (768)
       ...
       Category: Drawing planets
        ...
        Context: See this variable [on its own page](../loader/variable/cnt2.md)
     References: This variable is used as follows:
                 * [PLL1 (Part 2 of 3)](../loader/subroutine/pll1_part_2_of_3.md) uses CNT2
    ...
    .CNT2
     ...
     EQUW &01DD             \ The number of iterations of the PLL2 loop (477)
       ...
       Category: Drawing planets
        ...
        Context: See this variable [on its own page](../loader/variable/cnt3.md)
     Variations: See [code variations](../related/compare/loader/variable/cnt3.md) for this variable in the different versions
     References: This variable is used as follows:
                 * [PLL1 (Part 3 of 3)](../loader/subroutine/pll1_part_3_of_3.md) uses CNT3
    ...
    .CNT3
     ...
     EQUW &0333             \ The number of iterations of the PLL3 loop (819)
       ...
       Category: Maths (Arithmetic)
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/root.md)
     References: This subroutine is called as follows:
                 * [PLL1 (Part 1 of 3)](../loader/subroutine/pll1_part_1_of_3.md) calls ROOT
    ...
    * * *
    ...
    .LL7
     ...
     RTS                    \ Return from the subroutine
       ...
       Category: Utility routines
        ...
        Context: See this subroutine [on its own page](../loader/subroutine/osb.md)
     References: This subroutine is called as follows:
                 * [Elite loader](../loader/subroutine/elite_loader.md) calls OSB
    ...
    .OSB
     ...
     JMP OSBYTE             \ using a tail call (so we can call OSB to call OSBYTE
       ...
       Category: Loader
        ...
        Context: See this variable [on its own page](../loader/variable/mess1.md)
     References: This variable is used as follows:
                 * [Elite loader](../loader/subroutine/elite_loader.md) uses MESS1
    ...
    .MESS1
     ...
     EQUB 13
       ...
       Category: Loader
        ...
        Context: See this variable [on its own page](../loader/variable/mess2.md)
     References: This variable is used as follows:
                 * [Elite loader](../loader/subroutine/elite_loader.md) uses MESS2
    ...
    ENDIF
       ...
       Category: Loader
        ...
        Context: See this variable [on its own page](../loader/variable/mess3.md)
     References: This variable is used as follows:
                 * [Elite loader](../loader/subroutine/elite_loader.md) uses MESS3
...
Variable [B%](loader.md#header-b-per-cent) (category: Drawing the screen)

VDU commands for setting the square mode 1 screen

[X]

Variable [CNT](loader.md#header-cnt) (category: Drawing planets)

A counter for use in drawing Saturn's planetary body

[X]

Variable [CNT2](loader.md#header-cnt2) (category: Drawing planets)

A counter for use in drawing Saturn's background stars

[X]

Variable [CNT3](loader.md#header-cnt3) (category: Drawing planets)

A counter for use in drawing Saturn's rings

[X]

Subroutine [DORND](loader.md#header-dornd) (category: Maths (Arithmetic))

Generate random numbers

[X]

Variable [LATCH](loader.md#latch) in workspace [ZP](loader.md#header-zp)

The RAM copy of the currently selected paged ROM/RAM in SHEILA &30

[X]

Label [LL6](loader.md#ll6) in subroutine [ROOT](loader.md#header-root)

[X]

Label [LL7](loader.md#ll7) in subroutine [ROOT](loader.md#header-root)

[X]

Label [LL8](loader.md#ll8) in subroutine [ROOT](loader.md#header-root)

[X]

Label [LOOP](loader.md#loop) in subroutine [Elite loader](loader.md#header-elite-loader)

[X]

Variable [MESS1](loader.md#header-mess1) (category: Loader)

The OS command string for loading the BDATA binary

[X]

Variable [MESS2](loader.md#header-mess2) (category: Loader)

The OS command string for loading the main game code binary

[X]

Variable [MESS3](loader.md#header-mess3) (category: Loader)

The OS command string for changing the disc directory to E

[X]

Variable [MOS](loader.md#mos) in workspace [ZP](loader.md#header-zp)

Determines whether we are running on a Master Compact

[X]

Label [MPL1](loader.md#mpl1) in subroutine [Elite loader](loader.md#header-elite-loader)

[X]

Label [MPL2](loader.md#mpl2) in subroutine [Elite loader](loader.md#header-elite-loader)

[X]

Configuration variable [N%](loader.md#n-per-cent)

N% is set to the number of bytes in the VDU table, so we can loop through them below

[X]

Label [OK](loader.md#ok) in subroutine [Elite loader](loader.md#header-elite-loader)

[X]

Subroutine [OSB](loader.md#header-osb) (category: Utility routines)

A convenience routine for calling OSBYTE with Y = 0

[X]

Configuration variable [OSBYTE](loader.md#osbyte)

The address for the OSBYTE routine

[X]

Configuration variable [OSCLI](loader.md#oscli)

The address for the OSCLI routine

[X]

Configuration variable [OSWRCH](loader.md#oswrch)

The address for the OSWRCH routine

[X]

Variable [P](loader.md#p) in workspace [ZP](loader.md#header-zp)

Temporary storage, used in a number of places

[X]

Subroutine [PIX](loader.md#header-pix) (category: Drawing pixels)

Draw a single pixel at a specific coordinate

[X]

Label [PL1](loader.md#pl1) in subroutine [PLL1 (Part 3 of 3)](loader.md#header-pll1-part-3-of-3)

[X]

Label [PLC1](loader.md#plc1) in subroutine [PLL1 (Part 1 of 3)](loader.md#header-pll1-part-1-of-3)

[X]

Label [PLC2](loader.md#plc2) in subroutine [PLL1 (Part 2 of 3)](loader.md#header-pll1-part-2-of-3)

[X]

Label [PLC3](loader.md#plc3) in subroutine [PLL1 (Part 3 of 3)](loader.md#header-pll1-part-3-of-3)

[X]

Subroutine [PLL1 (Part 1 of 3)](loader.md#header-pll1-part-1-of-3) (category: Drawing planets)

Draw Saturn on the loading screen (draw the planet)

[X]

Label [PLL2](loader.md#pll2) in subroutine [PLL1 (Part 2 of 3)](loader.md#header-pll1-part-2-of-3)

[X]

Label [PLL3](loader.md#pll3) in subroutine [PLL1 (Part 3 of 3)](loader.md#header-pll1-part-3-of-3)

[X]

Variable [Q](loader.md#q) in workspace [ZP](loader.md#header-zp)

Temporary storage, used in a number of places

[X]

Variable [RAND](loader.md#header-rand) (category: Drawing planets)

The random number seed used for drawing Saturn

[X]

Subroutine [ROOT](loader.md#header-root) (category: Maths (Arithmetic))

Calculate ZP = SQRT(ZP(1 0))

[X]

Configuration variable [S%](loader.md#s-per-cent)

The address of the main entry point workspace in the main game code

[X]

Label [SQ1](loader.md#sq1) in subroutine [SQUA2](loader.md#header-squa2)

[X]

Label [SQL1](loader.md#sql1) in subroutine [SQUA2](loader.md#header-squa2)

[X]

Label [SQUA](loader.md#squa) in subroutine [SQUA2](loader.md#header-squa2)

[X]

Subroutine [SQUA2](loader.md#header-squa2) (category: Maths (Arithmetic))

Calculate (A P) = A * A

[X]

Variable [T](loader.md#t) in workspace [ZP](loader.md#header-zp)

Temporary storage, used in a number of places

[X]

Variable [TWOS](loader.md#header-twos) (category: Drawing pixels)

Ready-made single-pixel character row bytes for mode 1

[X]

Configuration variable [VIA](loader.md#via)

Memory-mapped space for accessing internal hardware, such as the video ULA, 6845 CRTC and 6522 VIAs (also known as SHEILA)

[X]

Variable [YY](loader.md#yy) in workspace [ZP](loader.md#header-zp)

Temporary storage, used in a number of places

[X]

Workspace [ZP](loader.md#header-zp) (category: Workspaces)
